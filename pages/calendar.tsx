...
const Calendar: NextPage = () => {
  ...
  if(!dataT) calendrier = {groupe: "Loading...", update: false, calendarId: ""}
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <div className={styles.gridVerticale}>
            {!dataT ? (<p>Loading...</p>) : (dataT.result.map((calendar: Calendrier) => {return (<CalendarItem key={calendar.calendarId} groupe={calendar.groupe}/>)}))}
          </div>
          
          <CalendarCard groupe={calendrier.groupe} update={calendrier.update} calendarId={calendrier.calendarId} />      
        </div>
        </div>
      </main>
      <Footer />
